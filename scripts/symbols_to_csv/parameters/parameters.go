...
const ADC_symbol string = "ZZ_ADC-DAC:ADC-DAC"
// DAC
const DAC_file   string = "DAC"
const DAC_folder string = "ADC-DAC"
const DAC_symbol string = "ZZ_ADC-DAC:ADC-DAC"

// Amplifier
const Amplifier_file   string = "Amplifier"
const Amplifier_folder string = "analogs"
const Amplifier_symbol string = "ZZ_analogs:analogs"

// Comparator
const Comparator_file   string = "Comparator"
const Comparator_folder string = "analogs"
const Comparator_symbol string = "ZZ_analogs:analogs"

// Connectors
const CPCI_connectors     string = "CPCI_connectors"
const CPCI_symbol         string = "ZZ_CPCI_connectors:CPCI_connectors"
const HE_connectors       string = "HE_connectors"
const HE_symbol           string = "ZZ_HE_connectors:HE_connectors"
const Lemo_connectors     string = "Lemo_connectors"
const Lemo_symbol         string = "ZZ_Lemo_connectors:Lemo_connectors"
const PSU_connectors      string = "PSU_connectors"
const PSU_symbol          string = "ZZ_PSU_connectors:PSU_connectors"
const RJ45_connectors     string = "RJ45_connectors"
const RJ45_symbol         string = "ZZ_RJ45_connectors:RJ45_connectors"
const SMA_connectors      string = "SMA_connectors"
const SMA_symbol          string = "ZZ_SMA_connectors:SMA_connectors"
const Terminal_connectors string = "Terminal_connectors"
const Terminal_symbol     string = "ZZ_Terminal_connectors:Terminal_connectors"
const Connectors_folder   string = "connectors"
const Connectors_symbol   string = "ZZ_connectors:connectors"
